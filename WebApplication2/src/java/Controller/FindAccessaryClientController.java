 ...
 * @author Admin
 */
@WebServlet(urlPatterns = {"/findclient"})
public class FindAccessaryClientController extends HttpServlet {
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet FindAccessaryClientController</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet FindAccessaryClientController at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        }
//    }
