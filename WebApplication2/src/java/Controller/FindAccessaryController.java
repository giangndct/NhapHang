 ...
 * @author Admin
 */
@WebServlet(name = "FindAccessaryController", urlPatterns = {"/findacc"})
public class FindAccessaryController extends HttpServlet {
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet FindAccessaryController</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet FindAccessaryController at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        }
//    }
